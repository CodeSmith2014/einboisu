...
<button data-toggle="modal" data-target="#addClientModal" class="btn btn-primary btn-lg pull-right header-btn hidden-mobile"><i class="fa fa-plus fa-lg"></i> Add New Client</button>
@stop
